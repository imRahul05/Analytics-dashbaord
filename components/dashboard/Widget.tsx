      ...
      <header className="drag-handle p-3 flex items-center justify-between border-b border-gray-700 cursor-move">
        ...
        {isEditor && (
          <div className="flex items-center gap-2">
            <button onClick={() => duplicateWidget(widget.id)} title="Duplicate Widget" className="p-1 widget-action-button">
            ...
            <button onClick={() => removeWidget(widget.id)} title="Remove Widget" className="p-1 widget-action-button">
